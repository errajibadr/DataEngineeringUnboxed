...
│                         MLKickstart_module and configuration for tools like black
│
...
│
└── MLKickstart_module   <- Source code for use in this project.
    │
    ├── __init__.py             <- Makes MLKickstart_module a Python module
    │
